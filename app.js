...
const ejs = require("ejs");0
const _=require("lodash")//lodash basically convert the express routing parameter for easy excess to upper and lower case  
